...
//            context.fill(barRect)
            ...
            if dataProvider.isDrawRoundedBarEnabled {
                ...
                if dataSet.gridColors.count == 2 {
                    let gradientColors = [ChartColorTemplates.colorFromString(dataSet.gridColors[0]).cgColor,ChartColorTemplates.colorFromString(dataSet.gridColors[1]).cgColor]
                    ...
                    let radians = (360.0).DEG2RAD
                    let centerPoint = CGPoint(x: barRect.midX, y: barRect.midY)
                    let xAngleDelta = cos(radians) * Double(barRect.width) / 2.0
                    let yAngleDelta = sin(radians) * Double(barRect.height) / 2.0
                    let startPoint = CGPoint(
                        x: centerPoint.x - CGFloat(xAngleDelta),
                        y: centerPoint.y - CGFloat(yAngleDelta)
                    )
...
//                context.fill(barRect)
                ...
                if dataProvider.isDrawRoundedBarEnabled
                {
                    ...
                    if set.gridColors.count == 2 {
                        let gradientColors = [ChartColorTemplates.colorFromString(set.gridColors[0]).cgColor,ChartColorTemplates.colorFromString(set.gridColors[1]).cgColor]
